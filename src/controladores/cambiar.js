...
export const actPagosSus = async (req, res) => {
  let params = {
    query: req.query,
    path: req.params,
    body: req.body,
  ...
  let resBD = await dao.updatePag(punto);
...
export const actSuscripciones = async (req, res) => {
  let params = {
    query: req.query,
    path: req.params,
    body: req.body,
  ...
  let resBD = await dao.updateSus(punto);
